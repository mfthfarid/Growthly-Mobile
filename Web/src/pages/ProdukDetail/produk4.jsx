...
// PERUBAHAN: Data disesuaikan untuk halaman produk 4
const otherRecipes = [
  {
    to: "/produk1",
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 via-pink-50 to-blue-50 overflow-hidden">
      ...
      <section 
        ...
        // PERUBAHAN: Gambar dan teks disesuaikan untuk Produk 4
        style={{ backgroundImage: "url('https://placehold.co/1920x400/fecdd3/333?text=Sup+Bola+Daging')"}}
        data-animate
      >
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <p className={`mt-4 text-lg text-white/90 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['produk-hero'] ? 'opacity-100' : 'opacity-0 translate-y-4'}`}>
            Makanan berkuah hangat yang penuh nutrisi, cocok untuk meningkatkan nafsu makan anak.
          </p>
        </div>
      </section>
           ...
           <div className={`transition-all duration-1000 ${isVisible['produk-content'] ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-center">
                    ...
                    <div className="bg-blue-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-blue-700">35 Menit</p>
                    </div>
                    <div className="bg-orange-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-orange-700">3-4 Porsi</p>
                    </div>
                </div>

                {/* Image Gallery */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <img src="https://placehold.co/600x400/fee2e2/333?text=Bahan+Sup" alt="Bahan-Bahan Sup" className="w-full h-auto rounded-2xl shadow-md" />
                    <img src="https://placehold.co/600x400/ecfdf5/333?text=Cara+Membuat+Kaldu" alt="Cara Membuat Kaldu" className="w-full h-auto rounded-2xl shadow-md" />
                </div>
            </div>
        </div>
      </main>

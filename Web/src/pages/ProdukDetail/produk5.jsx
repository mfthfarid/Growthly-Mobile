...
// PERUBAHAN: Data disesuaikan untuk halaman produk 5
const otherRecipes = [
  {
    to: "/produk1",
  ...
  {
    to: "/produk4", // Mengarah ke produk 4 sekarang
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 via-pink-50 to-blue-50 overflow-hidden">
      ...
      <section 
        ...
        // PERUBAHAN: Gambar dan teks disesuaikan untuk Produk 5
        style={{ backgroundImage: "url('https://placehold.co/1920x400/d1fae5/333?text=Pancake+Bayam+Keju')"}}
        data-animate
      >
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <p className={`mt-4 text-lg text-white/90 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['produk-hero'] ? 'opacity-100' : 'opacity-0 translate-y-4'}`}>
            Sarapan atau camilan gurih yang kaya akan zat besi dan kalsium, cara asyik makan sayur.
          </p>
        </div>
      </section>
           ...
           <div className={`transition-all duration-1000 ${isVisible['produk-content'] ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-center">
                    <div className="bg-green-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-green-700">Mudah</p>
                    </div>
                    <div className="bg-blue-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-blue-700">20 Menit</p>
                    </div>
                    <div className="bg-orange-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-orange-700">~8 Pancake</p>
                    </div>
                </div>

                {/* Image Gallery */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <img src="https://placehold.co/600x400/bbf7d0/333?text=Adonan+Pancake" alt="Adonan Pancake Bayam" className="w-full h-auto rounded-2xl shadow-md" />
                    <img src="https://placehold.co/600x400/f5d0fe/333?text=Hasil+Jadi" alt="Hasil Jadi Pancake" className="w-full h-auto rounded-2xl shadow-md" />
                </div>
            </div>
        </div>
      </main>

  ...
  return (
    <div className="bg-gradient-to-br from-green-50 via-pink-50 to-blue-50 overflow-hidden">
      ...
      <section 
        ...
        style={{ backgroundImage: "url('https://placehold.co/1920x400/dcfce7/333?text=MPASI+Sehat')"}}
        data-animate
      >
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <p className={`mt-4 text-lg text-white/90 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['produk-hero'] ? 'opacity-100' : 'opacity-0 translate-y-4'}`}>
            Resep MPASI super mudah, kaya akan lemak sehat dan kalium untuk mendukung perkembangan otak si kecil.
          </p>
        </div>
      </section>
           ...
           <div className={`transition-all duration-1000 ${isVisible['produk-content'] ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-center">
                    <div className="bg-green-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-green-700">Sangat Mudah</p>
                    </div>
                    <div className="bg-blue-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-blue-700">5 Menit</p>
                    </div>
                    <div className="bg-orange-100/70 p-4 rounded-xl">
                        ...
                        <p className="text-orange-700">1-2 Porsi</p>
                    </div>
                </div>

                {/* Image Gallery */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <img src="https://placehold.co/600x400/e2f5e8/333?text=Langkah+1" alt="Langkah 1" className="w-full h-auto rounded-2xl shadow-md" />
                    <img src="https://placehold.co/600x400/f3e8ff/333?text=Langkah+2" alt="Langkah 2" className="w-full h-auto rounded-2xl shadow-md" />
                </div>
            </div>
        </div>
      </main>
